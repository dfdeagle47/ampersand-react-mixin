...
module.exports = events.createEmitter({
  ...
  watch: function(modelOrCollection, opts) {
    var events = opts && opts.events ? opts.events : null,
      reRender = opts && opts.reRender ? opts.reRender : false;

    if (!events && modelOrCollection !== null && typeof modelOrCollection === 'object') {
    ...
    if (reRender) safeForceUpdate.call(this);
  },
